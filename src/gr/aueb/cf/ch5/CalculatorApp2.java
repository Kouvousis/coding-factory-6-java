...
public class CalculatorApp2 {
     ...
     * leads to divide by zero error (in div or mod) then the result
     * is Integer.MIN_VALUE.
     *
     * @param choice    Choice should be 1 for Add, 2 for Sub, 3 for Mul
     *                  4 for Div, 5 for Mod. Any other choice leads to an error
     *                  state and the method returns Integer.MAX_VALUE.
